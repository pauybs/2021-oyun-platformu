...
<div class="col-12 p-0 mt-5 mb-5 " >
	<div class="row  justify-content-center  m-0  mb-5 ">
		<div class="col-12 col-xl-9" >
			<div class="row  " >
				<?php
				$CokYakindaOyunlar = $DatabaseBaglanti->prepare("SELECT * FROM oyunlar Where Durum=1 and $Zaman<CikisTarihi ORDER BY CikisTarihi ASC ");
				$CokYakindaOyunlar->execute([14,1]);
				$Data = $CokYakindaOyunlar->rowCount();
				$CokYakindaOyunlarKayitlar = $CokYakindaOyunlar->fetchAll(PDO::FETCH_ASSOC);
				if ($Data>0 and $Data>4) {
					foreach ($CokYakindaOyunlarKayitlar as  $kayitlar) {
				?>
