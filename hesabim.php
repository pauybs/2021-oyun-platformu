			...
			<div class="row">
				<div class="col-12 col-xl-2 oRZNAEazx" >
					<div class="row mt-5 mb-5 p-0 justify-content-center align-items-center " >
						...
						<div class="col-12 mt-5  p-3 aRwQzWR">
							<a href="profilbilgileri"  ><h1 class=" font15 wwqeECZ_"><i class="fas fa-user ml-3 "></i> <span >Hesap Bilgileri</span></h1></a>
						</div>
						...
						if($KullaniciEditorDurumu=="0"){
							...
							<ul id="menu2" >
								<li><div class="col-8 text-center  bold mb-3 mt-3" ><a class="  " style="color: white " href="haberekle"><i   class="fas fa-plus "></i> <span>Haber Ekle</span></a></div></li>
								<li><div class="col-8 text-center bold mb-3" ><a class="" style="color: white " href="haberlerim"><i class="fas fa-file-signature ml-3"></i> <span>Haberlerim</span></a></div></li>
						...
						if($KullaniciKuratorDurumu=="0"){
							...
							<ul id="menu" >
								<li><div class="col-8 text-center  bold mb-3 mt-3" ><a style="color: white " href="oyuninceleme"><i class="fas fa-plus ml-3"></i> <span>İnceleme Yap</span></a></div></li>
								<li><div class="col-8 text-center bold mb-3" ><a class="" style="color: white " href="oyunincelemelerim"><i class="fas fa-file-signature ml-3"></i> <span>İncelemelerim</span></a></div></li>
							</ul>
							<?php
						}
						?>
				...
				<div class="d-none d-xl-block col-10">
					<div class="row mt-5 mb-5 justify-content-center align-items-center">
						<div class="col-5 " ><a href="profilbilgileri"  >
						...
						<div class="col-5" ><a href="guvenlikbilgileri" >
							<div class="row justify-content-center align-items-center text-center p-1">
								<div class="col-12 golge qzkkAZ___azmkdlq_" >
									<div class="row ">
										<div class="col-12 mt-5 "><i style="color: #c28f2c" class="fas fa-lock fa-5x"></i></div>
										<div class="col-12 mt-3"><span class="rtJMZwpmkt__Df" >Güvenlik</span></div>
										<div class="col-12 mb-5 "><span class="kzzmAJEUJ_yrMZASA" >Şifrenizi düzenleyin.</span></div>
									</div>
								</div>
							</div></a>
						</div>
