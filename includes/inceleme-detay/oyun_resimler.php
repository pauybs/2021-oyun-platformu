...
?>
	...
	$OyunResimler->execute([Guvenlik($OyunBilgilerKayit["id"])]);
				...
				?>
					...
					?>	
						<div class="swiper-slide"> 
							<img  src="images/games/pictures/<?php echo IcerikTemizle($Resimler["Resim"]); ?>" class="img-fluid " alt="<?php echo $OyunAdi; ?>"/>
