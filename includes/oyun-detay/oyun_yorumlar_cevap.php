...
?>
	...
	$YorumlarCevap->execute([Guvenlik($OyunSorgusuKayit["id"]),Guvenlik($YorumKayit["id"]),1,4]);
	...
	?>
		<div class="row odyc justify-content-center align-items-center pb-3 mt-1"  id="cs<?php echo IcerikTemizle($YorumCevapId) ?>"  >
				...
				<div class=" offset-1 col-11 asdRzwcZ">
					...
					?>
						<div class="col-12 up p-1">
							...
							?>
								<img src="images/userphoto/<?php echo IcerikTemizle($CevapYorumUye["ProfilResmi"]) ?> " class="img-fluid userp" >
							<?php
							}else{
							?>
						...
						?>	
												...
												<div class="col-12 text-center ycsb mt-2"></div>
													<form class="hesabim" id="ycg<?php echo IcerikTemizle($YorumCevapId); ?>" method="post" action="javascript:void(0);" >
														<div class="col-12 mt-2">
															...
															<textarea type="text" class="oydasx" name="OcSikayet"  maxlength="250"></textarea>
							...
							if(isset($_SESSION["Kullanici"]) and isset($_SESSION["Jeton"]) and Guvenlik($_SESSION["Kullanici"])==Guvenlik($KullaniciMail)   ){
								if ($KullaniciId == $YorumCevapKayit["UyeId"] ) {
							?>
								<span class="bold  white yorumk oycsb" data-type="<?php echo  IcerikTemizle($OyunId); ?>"  id="<?php echo IcerikTemizle($OyunSorgusuKayit["id"]) ?>" data-id="<?php echo IcerikTemizle($_SESSION["Jeton"]); ?>" data="<?php echo  IcerikTemizle($YorumCevapId); ?>" style="cursor:pointer;"><i style="color:#c28f2c"  class="fas fa-trash-alt white"></i> Yorumu Sil</span>
							<?php
							}
							}
							?>
